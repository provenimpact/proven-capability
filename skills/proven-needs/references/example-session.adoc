...
3. **needs-tasks** creates `docs/features/product-browsing/tasks.yaml` v2.0.0 (8 tasks, DAG with depends_on)
...
3. **needs-tasks** creates `docs/features/shopping-cart/tasks.yaml` v2.0.0 (9 tasks, DAG with depends_on)
...
3. **needs-tasks** creates `docs/features/checkout/tasks.yaml` v2.0.0 (7 tasks, DAG with depends_on)
4. **needs-implementation** implements code following task DAG order
5. **Divergence check:** needs-implementation reports no divergences
